        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 py-14 md:grid-cols-2 md:py-20">
          <div>
            ...
            <p className="mt-4 text-base text-slate-600 md:text-lg">
              Shop skincare, makeup, and fragrances made to feel luxurious and
              look effortless. Fast delivery, easy returns, and authentic
              products.
            </p>
          ...
          <div className="relative">
            <div className="rounded-3xl border border-rose-100 bg-white p-6 shadow-sm">
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-2xl bg-[url('skincare.jpeg')] p-5">
                  <p className="mt-4 text-sm font-semibold text-slate-900">
                    Skincare
                  </p>
                  <p className="text-xs text-slate-600">Hydrate & repair</p>
                </div>
                <div className="rounded-2xl bg-[url('makeup.jpeg')] p-5">
                  <p className="mt-4 text-sm font-semibold text-slate-900">
                    Makeup
                  </p>
                  <p className="text-xs text-slate-600">Soft glam everyday</p>
                </div>
                <div className="rounded-2xl bg-[url('fragrance.jpeg')] p-5">
                  <p className="mt-4 text-sm font-semibold text-slate-900">
                    Fragrance
                  </p>
                  <p className="text-xs text-slate-600">Fresh & floral</p>
                </div>
                <div className="rounded-2xl bg-[url('haircare.jpeg')] p-5">
                  <p className="mt-4 text-sm font-semibold text-slate-900">
                    Hair
                  </p>
              ...
              <div className="mt-5 rounded-2xl border border-slate-200 bg-white p-4">
                ...
                <p className="text-xs text-slate-500">
                  Juicy shine • Non-sticky • Vitamin E
                </p>
      ...
      <section id="categories" className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            {
              title: "Skincare",
              desc: "Cleansers, serums, moisturizers",
              bg: "bg-rose-100",
            },
            {
              title: "Makeup",
              desc: "Lips, eyes, face essentials",
              bg: "bg-pink-100",
            },
            {
              title: "Fragrance",
              desc: "Fresh, floral, woody",
              bg: "bg-fuchsia-100",
            },
            {
              title: "Haircare",
              desc: "Shampoo, masks, oils",
              bg: "bg-amber-100",
            },
          ].map((c) => (
            <Link
      ...
      <section id="reviews" className="mx-auto max-w-6xl px-4 pb-16">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          {[
            {
              name: "Ayesha",
              text: "Fast delivery and the products are original. My skin feels amazing!",
            },
            {
              name: "Nimal",
              text: "Great prices and super clean packaging. Will order again.",
            },
            {
              name: "Sadeeka",
              text: "The lipstick shade range is perfect. Customer service is so helpful.",
            },
          ].map((r) => (
            <div
              key={r.name}
